...
#  #print(code)
  ...
  writeFunctionRdFiles(path=p,docs,nsi)
  ...
  cat("Moving Rd files to man dir:\n")
  file.copy(file.path(name,'man'),"..",recursive=TRUE)
  
  #overwrite with files from manMan
  #fixme:mm
  #make a test if the file exists in manMan
  pe(quote(getwd()))
  manPath<-file.path("..","man")
